  ...
  if (mode === "flight") {
    return (
      <svg aria-hidden="true" className="size-9 drop-shadow-[0_4px_6px_rgba(0,0,0,0.22)]" viewBox="0 0 64 64">
        <path
          d="M47.8 9.8C49.9 9.8 51.6 11.5 51.6 13.6C51.6 14 51.5 14.5 51.4 14.9L46.8 28.3L54.9 30.5C56.8 31 58.1 32.7 58.1 34.7C58.1 36.7 56.8 38.4 54.9 38.9L46.8 41.1L42.8 53.6C42.2 55.3 40.6 56.4 38.8 56.4C36.8 56.4 35.2 55 34.8 53L31.8 40L22.6 45C21.9 45.4 21.1 45.6 20.3 45.6C18.7 45.6 17.2 44.7 16.4 43.4C15.3 41.6 15.7 39.3 17.4 38L24.8 32.6L17.4 27.2C15.7 25.9 15.3 23.6 16.4 21.8C17.2 20.5 18.7 19.6 20.3 19.6C21.1 19.6 21.9 19.8 22.6 20.2L31.8 25.2L34.8 12.2C35.2 10.2 36.8 8.8 38.8 8.8C40.6 8.8 42.2 9.9 42.8 11.6L46 19.2L44.5 24.7L47.8 15.4C47.9 15.1 48 14.8 48 14.5C48 13.7 47.3 13 46.5 13H41.1L42.4 9.8H47.8Z"
          fill="#f4fff7"
        />
        <path
          d="M39.2 12.7L35.1 29.6L25.6 24.4C25 24.1 24.3 23.9 23.6 23.9C22 23.9 20.6 24.8 19.9 26.1C19.2 27.4 19.4 29 20.5 29.9L28.8 36L20.5 42.1C19.4 43 19.2 44.6 19.9 45.9C20.6 47.2 22 48.1 23.6 48.1C24.3 48.1 25 47.9 25.6 47.6L35.1 42.4L39.1 58.1L43 41.9L54.1 38.8C55.6 38.4 56.6 37 56.6 35.5C56.6 34 55.6 32.6 54.1 32.2L43 29.1L39.2 12.7Z"
          fill="#86efac"
          opacity="0.42"
        />
        <path
          d="M39.1 12.7L42.8 27.8L54.1 31C55.6 31.4 56.6 32.8 56.6 34.3C56.6 35.8 55.6 37.2 54.1 37.6L42.8 40.8L39.1 56L35.4 40.8L25.4 46.3C24.8 46.6 24.2 46.8 23.5 46.8C22.2 46.8 21 46.1 20.4 45C19.8 43.9 20.1 42.5 21 41.8L30.4 34.9L21 28.1C20.1 27.4 19.8 26 20.4 24.9C21 23.8 22.2 23.1 23.5 23.1C24.2 23.1 24.8 23.3 25.4 23.6L35.4 29.1L39.1 12.7Z"
          fill="none"
          stroke="#dcfce7"
