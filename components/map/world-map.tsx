  ...
  if (mode === "flight") {
    return (
      <svg aria-hidden="true" className="size-9 drop-shadow-[0_4px_6px_rgba(0,0,0,0.22)]" viewBox="0 0 64 64">
        <path
          d="M19.2 16.3C18.4 15.5 18.4 14.2 19.3 13.5L23 10.7C23.5 10.3 24.2 10.2 24.8 10.4L40.1 15.1L48.8 8.2C52 5.7 56.7 5.8 58.5 8.5C60.2 11 58.9 15 55.4 18.4L48.5 25.1L53.4 40.4C53.6 41 53.5 41.7 53.1 42.2L50.2 46C49.5 46.9 48.2 46.9 47.5 46.1L41.3 39.2L31 49.5C29.6 50.9 27.4 51 26.1 49.7C24.8 48.4 24.9 46.2 26.3 44.8L36.6 34.5L29.7 27.6L18.7 38.6C17.4 39.9 15.4 40.1 14.1 38.8L12 36.7C10.7 35.4 10.9 33.4 12.2 32.1L23.2 21.1L19.2 16.3Z"
          fill="#7eb27a"
        />
        <path
          d="M24.5 11.8L38.8 16.1L28 26.9L20.9 18.3L24.5 11.8Z"
          fill="#98c892"
          opacity="0.9"
        />
        <path
          d="M27.4 45.7L37.1 36L44.2 43.1L34.3 53C33.1 54.2 31.3 54.3 30.2 53.2L27.1 50.1C26 49 26.1 47 27.4 45.7Z"
          fill="#6ca368"
          opacity="0.92"
        />
        <path
          d="M18.6 31.6L29.8 20.4L35.5 26.1L24.4 37.3C23 38.7 20.9 38.8 19.8 37.7L18.2 36.1C17.1 35 17.2 33 18.6 31.6Z"
          fill="#98c892"
          opacity="0.92"
        />
        <path
          d="M51 13.3C52.7 11.6 55.2 11.4 56.1 12.8C57 14.1 56.3 16.3 54.4 18.2L47 25.5L38.9 17.4L46.2 10.2C47.7 8.7 49.9 8.3 51.2 9.2C52.5 10.1 52.4 11.6 51 13.3Z"
          fill="#6ca368"
        />
        <path
          d="M19.2 16.3C18.4 15.5 18.4 14.2 19.3 13.5L23 10.7C23.5 10.3 24.2 10.2 24.8 10.4L40.1 15.1L48.8 8.2C52 5.7 56.7 5.8 58.5 8.5C60.2 11 58.9 15 55.4 18.4L48.5 25.1L53.4 40.4C53.6 41 53.5 41.7 53.1 42.2L50.2 46C49.5 46.9 48.2 46.9 47.5 46.1L41.3 39.2L31 49.5C29.6 50.9 27.4 51 26.1 49.7C24.8 48.4 24.9 46.2 26.3 44.8L36.6 34.5L29.7 27.6L18.7 38.6C17.4 39.9 15.4 40.1 14.1 38.8L12 36.7C10.7 35.4 10.9 33.4 12.2 32.1L23.2 21.1L19.2 16.3Z"
        ...
        />
        <path
          d="M45.6 15.2C46.7 14.1 48.2 13.8 49 14.5C49.8 15.3 49.5 16.8 48.4 17.8"
          fill="none"
          opacity="0.9"
          stroke="#1f2b2d"
          strokeLinecap="round"
