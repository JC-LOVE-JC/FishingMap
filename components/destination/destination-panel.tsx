...
export function DestinationPanel({
  ...
  const panelContent = (
    ...
    >
      <button
        className="relative z-10 shrink-0 border-b border-white/8 px-5 pb-3 pt-3 text-left lg:hidden"
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "safe-x safe-bottom pointer-events-none absolute inset-x-3 bottom-3 top-[5.9rem] z-20 flex flex-col transition-transform duration-300 lg:hidden"
        )}
      ...
      >
        <div className="pointer-events-auto justify-center lg:order-1 lg:mt-0 lg:flex lg:items-start lg:pt-4">
          <button
        ...
        <div className="w-[30rem] max-w-[calc(100vw-6rem)]">
          {panelContent}
        </div>
      </div>
    </>
